  ...
  return (
    <div className="h-[10%]  bg-black flex justify-between items-center text-white px-4">
     <div className="hidden lg:flex items-center gap-4">
       ...
       { !playerStatus ? <img onClick={play} className="w-4 cursor-pointer" src={assets.play_icon} alt="" />: <img onClick={pause} className="w-4 cursor-pointer" src={assets.pause_icon} alt="" /> }     
