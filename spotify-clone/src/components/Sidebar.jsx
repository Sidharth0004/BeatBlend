    ...
    <div className="w-[25%] h-full  p-2 flex-col gap-2  text-white hidden lg:flex">
       ...
       <div className=" bg-[#121212] h-[85%] rounded">
            <div className="p-4 flex  items-center  justify-between ">
                ...
                <button className="px-4 w-[45%] py-1.5 bg-white text-[15px] text-black rounded-full mt-4">Create Playlist</button>
                </div>
                ...
                <button className="px-4 w-[45%]  py-1.5 bg-white text-[15px] text-black rounded-full mt-4">Browse Podcast</button>
                </div>
